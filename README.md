...
[![npm - core](https://img.shields.io/npm/v/@zilliz/claude-context-core?label=%40zilliz%2Fclaude-context-core&logo=npm)](https://www.npmjs.com/package/@everwise/claude-context-core)
[![npm - mcp](https://img.shields.io/npm/v/@zilliz/claude-context-mcp?label=%40zilliz%2Fclaude-context-mcp&logo=npm)](https://www.npmjs.com/package/@everwise/claude-context-mcp)
...
claude mcp add claude-context \
  ...
  -- npx @everwise/claude-context-mcp@latest
```
...
```json
{
  "mcpServers": {
    "claude-context": {
      "command": "npx",
      "args": ["@everwise/claude-context-mcp@latest"],
      "env": {
...
```json
{
  "mcpServers": {
    "claude-context": {
      "command": "npx",
      "args": ["-y", "@everwise/claude-context-mcp@latest"],
      "env": {
        "OPENAI_API_KEY": "your-openai-api-key",
        "MILVUS_ADDRESS": "your-zilliz-cloud-public-endpoint",
        "MILVUS_TOKEN": "your-zilliz-cloud-api-key"
...
2. Fill in the server details:
   ...
   - **Type**: `STDIO`
   - **Command**: `npx`
   - **Arguments**: `["@everwise/claude-context-mcp@latest"]`
...
- **`@everwise/claude-context-core`**: Core indexing engine with embedding and vector database integration
- **VSCode Extension**: Semantic Code Search extension for Visual Studio Code
- **`@everwise/claude-context-mcp`**: Model Context Protocol server for AI agent integration
...
The `@everwise/claude-context-core` package provides the fundamental functionality for code indexing and semantic search.
